	...
	<div class="col-md-6">
		<div class="card">
			...
			<div class="card-body">
				...
				<div class="form-check form-check-radio">
				    <label class="form-check-label">
						<input class="form-check-input" type="radio" name="jak_chatgpt" value="1"<?php if ($JAK_FORM_DATA["chatgpt"] == 1) echo ' checked';?>>
						<span class="form-check-sign"></span>
						<?php echo $jkl["g19"];?>
					</label>
				</div>
				<div class="form-check form-check-radio">
				    <label class="form-check-label">
						<input class="form-check-input" type="radio" name="jak_chatgpt" value="0"<?php if ($JAK_FORM_DATA["chatgpt"] == 0) echo ' checked';?>>
						<span class="form-check-sign"></span>
						<?php echo $jkl["g18"];?>
					</label>
				</div>
				...
				<div class="form-group">
					<label for="chatgpt_helpful"><?php echo $jkl["g356"];?></label>
					<input type="text" name="jak_chatgpt_helpful" id="chatgpt_helpful" class="form-control" value="<?php echo $JAK_FORM_DATA["chatgpt_helpful"];?>">
				</div>
