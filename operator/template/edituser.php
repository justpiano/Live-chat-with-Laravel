	...
	<div class="col-md-6">
		...
		<div class="card-body">
			...
			<div class="form-check form-check-inline">
  				<label class="form-check-label">
    			<input class="form-check-input" type="checkbox" name="jak_roles[]" value="leads"<?php if (in_array("leads", explode(',', (string)$JAK_FORM_DATA["permissions"]))) { ?> checked="checked"<?php } ?>>
			...
			<div class="form-check form-check-inline">
  				<label class="form-check-label">
    			<input class="form-check-input" type="checkbox" name="jak_roles[]" value="leads_all"<?php if (in_array("leads_all", explode(',', (string)$JAK_FORM_DATA["permissions"]))) { ?> checked="checked"<?php } ?>>
			...
			<div class="form-check form-check-inline">
  				<label class="form-check-label">
    			<input class="form-check-input" type="checkbox" name="jak_roles[]" value="off_all"<?php if (in_array("off_all", explode(',', (string)$JAK_FORM_DATA["permissions"]))) { ?> checked="checked"<?php } ?>>
			...
			<div class="form-check form-check-inline">
  				<label class="form-check-label">
    			<input class="form-check-input" type="checkbox" name="jak_roles[]" value="ochat"<?php if (in_array("ochat", explode(',', (string)$JAK_FORM_DATA["permissions"]))) { ?> checked="checked"<?php } ?>>
			...
			<div class="form-check form-check-inline">
  				<label class="form-check-label">
    			<input class="form-check-input" type="checkbox" name="jak_roles[]" value="ochat_all"<?php if (in_array("ochat_all", explode(',', (string)$JAK_FORM_DATA["permissions"]))) { ?> checked="checked"<?php } ?>>
			...
			<div class="form-check form-check-inline">
  				<label class="form-check-label">
    			<input class="form-check-input" type="checkbox" name="jak_roles[]" value="statistic"<?php if (in_array("statistic", explode(',', (string)$JAK_FORM_DATA["permissions"]))) { ?> checked="checked"<?php } ?>>
			...
			<div class="form-check form-check-inline">
  				<label class="form-check-label">
    			<input class="form-check-input" type="checkbox" name="jak_roles[]" value="statistic_all"<?php if (in_array("statistic_all", explode(',', (string)$JAK_FORM_DATA["permissions"]))) { ?> checked="checked"<?php } ?>>
			...
			<div class="form-check form-check-inline">
  				<label class="form-check-label">
    			<input class="form-check-input" type="checkbox" name="jak_roles[]" value="files"<?php if (in_array("files", explode(',', (string)$JAK_FORM_DATA["permissions"]))) { ?> checked="checked"<?php } ?>>
			...
			<div class="form-check form-check-inline">
  				<label class="form-check-label">
    			<input class="form-check-input" type="checkbox" name="jak_roles[]" value="proactive"<?php if (in_array("proactive", explode(',', (string)$JAK_FORM_DATA["permissions"]))) { ?> checked="checked"<?php } ?>>
			...
			<div class="form-check form-check-inline">
  				<label class="form-check-label">
    			<input class="form-check-input" type="checkbox" name="jak_roles[]" value="usrmanage"<?php if (in_array("usrmanage", explode(',', (string)$JAK_FORM_DATA["permissions"]))) { ?> checked="checked"<?php } ?>>
			...
			<div class="form-check form-check-inline">
  				<label class="form-check-label">
    			<input class="form-check-input" type="checkbox" name="jak_roles[]" value="responses"<?php if (in_array("responses", explode(',', (string)$JAK_FORM_DATA["permissions"]))) { ?> checked="checked"<?php } ?>>
			...
			<div class="form-check form-check-inline">
  				<label class="form-check-label">
    			<input class="form-check-input" type="checkbox" name="jak_roles[]" value="departments"<?php if (in_array("departments", explode(',', (string)$JAK_FORM_DATA["permissions"]))) { ?> checked="checked"<?php } ?>>
			...
			<div class="form-check form-check-inline">
  				<label class="form-check-label">
    			<input class="form-check-input" type="checkbox" name="jak_roles[]" value="settings"<?php if (in_array("settings", explode(',', (string)$JAK_FORM_DATA["permissions"]))) { ?> checked="checked"<?php } ?>>
			...
			<div class="form-check form-check-inline">
  				<label class="form-check-label">
    			<input class="form-check-input" type="checkbox" name="jak_roles[]" value="maintenance"<?php if (in_array("maintenance", explode(',', (string)$JAK_FORM_DATA["permissions"]))) { ?> checked="checked"<?php } ?>>
			...
			<div class="form-check form-check-inline">
  				<label class="form-check-label">
    			<input class="form-check-input" type="checkbox" name="jak_roles[]" value="logs"<?php if (in_array("logs", explode(',', (string)$JAK_FORM_DATA["permissions"]))) { ?> checked="checked"<?php } ?>>
			...
			<div class="form-check form-check-inline">
  				<label class="form-check-label">
    			<input class="form-check-input" type="checkbox" name="jak_roles[]" value="answers"<?php if (in_array("answers", explode(',', (string)$JAK_FORM_DATA["permissions"]))) { ?> checked="checked"<?php } ?>>
			...
			<div class="form-check form-check-inline">
  				<label class="form-check-label">
    			<input class="form-check-input" type="checkbox" name="jak_roles[]" value="widget"<?php if (in_array("widget", explode(',', (string)$JAK_FORM_DATA["permissions"]))) { ?> checked="checked"<?php } ?>>
			...
			<div class="form-check form-check-inline">
  				<label class="form-check-label">
    			<input class="form-check-input" type="checkbox" name="jak_roles[]" value="groupchat"<?php if (in_array("groupchat", explode(',', (string)$JAK_FORM_DATA["permissions"]))) { ?> checked="checked"<?php } ?>>
			...
			<div class="form-check form-check-inline">
  				<label class="form-check-label">
    			<input class="form-check-input" type="checkbox" name="jak_roles[]" value="blacklist"<?php if (in_array("blacklist", explode(',', (string)$JAK_FORM_DATA["permissions"]))) { ?> checked="checked"<?php } ?>>
			...
			<div class="form-check form-check-inline">
  				<label class="form-check-label">
    			<input class="form-check-input" type="checkbox" name="jak_roles[]" value="blocklist"<?php if (in_array("blocklist", explode(',', (string)$JAK_FORM_DATA["permissions"]))) { ?> checked="checked"<?php } ?>>
