...
<div class="row">
	...
	<div class="col-md-8">
		...
		<div class="card-body">
			...
			<div class="form-group">
				<p><label for="jak_chatstyle"><?php echo $jkl["cw46"];?></label></p>
				<select name="jak_chatstyle" class="selectpicker">
					<option value="0"<?php if ($JAK_FORM_DATA["chatstyle"] == 0) { ?> selected="selected"<?php } ?>><?php echo $jkl['cw48'];?></option>
					<option value="1"<?php if ($JAK_FORM_DATA["chatstyle"] == 1) { ?> selected="selected"<?php } ?>><?php echo $jkl['cw47'];?></option>
				</select>
			</div>

			<div class="form-group">
				<p><label for="jak_bgimage"><?php echo $jkl["cw45"];?></label></p>
				<select name="jak_bgimage" id="chatbgimage" class="selectpicker">
					<option value="0"<?php if ($JAK_FORM_DATA["bgimage"] == 0) { ?> selected="selected"<?php } ?>>1</option>
					<option value="1"<?php if ($JAK_FORM_DATA["bgimage"] == 1) { ?> selected="selected"<?php } ?>>2</option>
					<option value="2"<?php if ($JAK_FORM_DATA["bgimage"] == 2) { ?> selected="selected"<?php } ?>>3</option>
					<option value="3"<?php if ($JAK_FORM_DATA["bgimage"] == 3) { ?> selected="selected"<?php } ?>>4</option>
					<option value="4"<?php if ($JAK_FORM_DATA["bgimage"] == 4) { ?> selected="selected"<?php } ?>>5</option>
				</select>
			</div>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div id="bg_preview_button">
						<img src="<?php echo BASE_URL_ORIG;?>/img/groupchat<?php echo ($JAK_FORM_DATA["bgimage"] != 0 ? $JAK_FORM_DATA["bgimage"] : '');?>.jpg" class="img-responsive img-thumbnail" alt="bgchat">
					</div>
				</div>
			</div>
