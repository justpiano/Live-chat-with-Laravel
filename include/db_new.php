...
define('JAKDB_USER', 'your_db_user_goes_here'); // Database user ## Datenbank Benutzername
define('JAKDB_PASS', 'your_db_password_goes_here'); // Database password ## Datenbank Passwort
define('JAKDB_NAME', 'your_db_name_goes_here'); // Database name ## Datenbank Name
define('JAKDB_PREFIX', 'lc3_'); // Database prefix use (a-z) and (_)

// Define a unique key for your site, don't change after, or people can't login anymore. (https://jakweb.ch/faq/a/99/database-and-password-hash)
